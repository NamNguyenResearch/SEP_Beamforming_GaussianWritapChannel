...
% W_0 = [0.3252   1.3703;  -0.7549, -1.7115];
...
plot(iterations,objective_function,'b');
grid on
hold on
plot(iterations,objective_function_Bob,'r');
plot(iterations,objective_function_Eve,'g');
hold off
xlabel('Iterations');
ylabel('Values');
legend('Objective Value', 'Error Probability of Bob', 'Error Probability of Eve');