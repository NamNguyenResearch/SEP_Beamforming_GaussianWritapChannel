...
% N_E = 0.05, N_B = 0.01, Var_B = Var_E = 0.1, D = 0.1 => Fig. 1
% N_E = 0.05, N_B = 0.01, Var_B = Var_E = 0.1, D = 0.2 => Fig. 2
% N_E = 0.01, N_B = 0.01, Var_B = Var_E = 0.1, D = 0.2 => Fig. 3
% N_E = 0.03, N_B = 0.01, Var_B = Var_E = 0.1, D = 0.2 => Fig. 4
% N_E = 0.02, N_B = 0.01, Var_B = Var_E = 0.1, D = 0.2 => Fig. 5

% N_B = 0.01, N_E = 0.01, D = 0.3, var_B = var_E = 0.01 -> Test
...
SNR_dB = [-10, -8, -6, -4, -2, 0, 2, 4, 6, 8.5, 10, 11, 12];
SNR = 10.^(SNR_dB/10);
...
for num = 1:num_MonteCarlo 
    ...
    % % Test 1
    % H_B = [-0.0387 + 0.0516i -0.1702 - 0.0125i; -0.0141 - 0.1283i 0.0132 + 0.0902i];
    % H_E = [0.0998 + 0.0016i -0.0693 + 0.0612i; 0.0025 - 0.0026i -0.0268 + 0.0085i];
    
    % % Test 2
    % H_B = [0.0690 - 0.1505i -0.0337 + 0.0844i; -0.0662 - 0.0556i 0.2007 + 0.1106i];
    % H_E = [-0.0248 + 0.1062i 0.0267 - 0.0529i; -0.1206 + 0.0396i 0.0119 + 0.0212i];
    
    % Test 3
    H_B = [-0.0854 + 0.1241i -0.0038 - 0.0286i; 0.1291 - 0.0575i -0.0345 + 0.0952i];
    H_E = [-0.0258 - 0.0657i -0.0514 - 0.0075i; 0.0968 + 0.0523i -0.0752 + 0.0008i];
